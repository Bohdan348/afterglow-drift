...
const grain=grainTexture();grain.wrapS=grain.wrapT=T.RepeatWrapping;grain.repeat.set(28,28);
 ...
 const farGround=new T.Mesh(new T.PlaneGeometry(26000,26000),new T.MeshStandardMaterial({color:'#52644a',roughness:1}));farGround.rotation.x=-Math.PI/2;farGround.position.y=minY-1;farGround.receiveShadow=true;group.add(farGround);
